...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function loginUser() {
          ...
          this._auth.loginUser(this.loginUserData).subscribe(function (res) {
            ...
            _this11.response = err.error.error_description;
          });
        }
      }]);
    ...
    function () {
      ...
      _createClass(RegisterComponent, [{
        ...
        value: function registerUser() {
          ...
          this._userService.registerUser(this.registerUserData).subscribe(function () {
            _this15._router.navigate(['/login']);
          }, function (err) {
            _this15.response = err.error;
          });
        }
      }]);
    ...
    function () {
      ...
      _createClass(ResetPasswordComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this._route.queryParams.subscribe(function (params) {
            _this16.user.id = _this16._route.snapshot.params['id'];
            _this16.user.code = params['code'].replace(/\s/g, '+');
          });
        }
      }, {
        key: "resetPassword",
        value: function resetPassword() {
          ...
          this._userService.resetPasswordUser(this.user).subscribe(function (res) {
            ...
            setTimeout(function () {
              _this17._authService.logoutUser();
            }, 1000);
          }, function (err) {
            return console.log(err);
          });
    ...
    function () {
      ...
      _createClass(AuthService, [{
        ...
        value: function refreshToken() {
          ...
          return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].tokenEndpoint, params).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (tokens) {
            return _this19.storeTokens(tokens);
            ...
            _this19._router.navigate(['/login']);
        ...
        value: function intercept(request, next) {
          ...
          return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) {
            if (error instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpErrorResponse"] && error.status === 401) {
              return _this20.handle401Error(request, next);
            } else {
        ...
        value: function handle401Error(request, next) {
          ...
          if (!this.isRefreshing) {
            ...
            return this.authService.refreshToken().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function () {
              ...
              _this21.refreshTokenSubject.next(_this21.authService.getAccessToken());

              return next.handle(_this21.addToken(request, _this21.authService.getAccessToken()));
            }));
          } else {
            return this.refreshTokenSubject.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(function (token) {
              ...
              return next.handle(_this21.addToken(request, access_token));
            }));
          }
        }
      }]);
    ...
    function () {
      ...
      _createClass(UserService, [{
        ...
        value: function deleteUser(passwordUserData) {
          ...
          return this._http.delete(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].usersEndpoint, httpOptions);
        }
      }, {
  ...
  function srcAppSharedStylesLoginlogoutformScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".alert-message {\n  font-size: 10pt;\n  color: #f74242;\n  position: absolute;\n  margin-top: 6px;\n}\n\n.text {\n  margin-top: 25px;\n}\n\n.reg-form {\n  padding-top: 10px;\n}\n\nblockquote, q {\n  quotes: none;\n}\n\nblockquote:before, blockquote:after, q:before, q:after {\n  content: \"\";\n  content: none;\n}\n\n/*-- main --*/\n\n.main-w3layouts {\n  padding: 3em 0 1em;\n}\n\n.main-agileinfo {\n  width: 35%;\n  min-width: 357px;\n  margin: 3em auto;\n  background: rgba(0, 0, 0, 0.6);\n  background-size: cover;\n  padding: 40px;\n}\n\n.agileits-top {\n  font-size: 0.9em;\n}\n\n.text:focus, .text:valid {\n  box-shadow: none;\n  outline: none;\n}\n\n.text:focus::-webkit-input-placeholder, .text:valid::-webkit-input-placeholder {\n  color: rgba(255, 255, 255, 0.7);\n  font-size: 0.9em;\n  -webkit-transform: translateY(-30px);\n  transform: translateY(-30px);\n  visibility: visible !important;\n}\n\n::-webkit-input-placeholder {\n  color: #fff;\n  font-weight: 100;\n}\n\n:-moz-placeholder {\n  /* Firefox 18- */\n  color: #fff;\n}\n\n::-moz-placeholder {\n  /* Firefox 19+ */\n  color: #fff;\n}\n\n:-ms-input-placeholder {\n  color: #fff;\n}\n\ninput[type=submit] {\n  font-size: 0.9em;\n  color: #fff;\n  background: #76b852;\n  outline: none;\n  border: 1px solid #76b852;\n  cursor: pointer;\n  padding: 0.9em;\n  -webkit-appearance: none;\n  width: 100%;\n  margin: 2em 0;\n  letter-spacing: 4px;\n}\n\ninput[type=submit]:hover {\n  -webkit-transition: 0.5s all;\n  transition: 0.5s all;\n  background: #8DC26F;\n}\n\n.agileits-top p {\n  font-size: 1em;\n  color: #fff;\n  text-align: center;\n  letter-spacing: 1px;\n  font-weight: 300;\n}\n\n.agileits-top p a {\n  color: #fff;\n  -webkit-transition: 0.5s all;\n  transition: 0.5s all;\n  font-weight: 400;\n}\n\n.agileits-top p a:hover {\n  color: #76b852;\n}\n\n@-webkit-keyframes rippling {\n  50% {\n    border-left-color: #fff;\n  }\n  100% {\n    border-bottom-color: #fff;\n    border-left-color: #fff;\n  }\n}\n\n@keyframes rippling {\n  50% {\n    border-left-color: #fff;\n  }\n  100% {\n    border-bottom-color: #fff;\n    border-left-color: #fff;\n  }\n}\n\n/*-- //checkbox --*/\n\n/*-- copyright --*/\n\n.colorlibcopy-agile {\n  margin: 2em 0 1em;\n  text-align: center;\n}\n\n.colorlibcopy-agile p {\n  font-size: 0.9em;\n  color: #fff;\n  line-height: 1.8em;\n  letter-spacing: 1px;\n  font-weight: 100;\n}\n\n.colorlibcopy-agile p a {\n  color: #fff;\n  transition: 0.5s all;\n  -webkit-transition: 0.5s all;\n  -moz-transition: 0.5s all;\n  -o-transition: 0.5s all;\n  -ms-transition: 0.5s all;\n}\n\n.colorlibcopy-agile p a:hover {\n  color: #000;\n}\n\n/*-- //copyright --*/\n\n.wrapper {\n  position: relative;\n  overflow: hidden;\n}\n\n.response {\n  position: absolute;\n  font-size: 10pt;\n  color: #f74242;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\NETFULLY\Desktop\dev\src\FM.Application\ClientApp\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
