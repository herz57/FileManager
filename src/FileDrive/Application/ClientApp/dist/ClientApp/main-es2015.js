...
let AuthService = class AuthService {
    ...
    loginUser(user) {
        ...
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].tokenEndpoint, params)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(tokens => this.storeTokens(tokens)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["mapTo"])(true));
    }
    logoutUser() {
